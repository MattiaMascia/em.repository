...
df=pd.read_csv("C://Users//Loredana//Desktop//Academy MM//PYTHON//PROGETTO//THE-MOVIES-DATASET//movies_metadata.csv",low_memory=False)
...
df_metadata_clean.to_csv("C://Users//Loredana//Desktop//Academy MM//PYTHON//PROGETTO//movies_metadata_CLEAN.csv",index=False)