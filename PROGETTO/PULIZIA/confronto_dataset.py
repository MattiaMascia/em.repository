...
df_rat=pd.read_csv("C://Users//Loredana//Desktop//Academy MM//PYTHON//PROGETTO//ratings_CLEAN.csv",low_memory=False)
df_movie=pd.read_csv("C://Users//Loredana//Desktop//Academy MM//PYTHON//PROGETTO//movies_metadata_CLEAN_ID.csv",low_memory=False)
