#PANDAS E' PRINCIPALMENTE UTILIZZATO PER VISUALIZZAZIONE E PULIZIA DEI DATI
#PRINCIPALMEMTE E' USATO PER DATAFRAME E SERIES 
#IL DATAFRAME E' L'EVOLUZIONE DELL'ARRAY DI NUMPY


#####PRIMO ESEMPIO CON PANDAS###
import pandas as pd

# Creazione di un DataFrame con dati di esempio
data = {'Nome': ['Alice','Bob','Carla'], 'Età': [25, 30, 22], 'Città': ['Roma','Milano','Napoli']}
